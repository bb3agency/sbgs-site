...
export function WhyChooseBand() {
  return (
    <section className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] bg-brand-maroon bg-[url('/images/whychooseus-mobile.png')] bg-cover bg-center md:bg-[url('/images/whychooseus-desktop.png')] px-4 py-10 sm:px-6 sm:py-24 lg:px-10">
