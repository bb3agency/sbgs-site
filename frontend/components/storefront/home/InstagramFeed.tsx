    ...
    <section className="relative overflow-hidden bg-brand-maroon">
      <div className="relative mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="mb-12 flex flex-col items-center justify-between gap-6 md:flex-row">
          {/* Left: Heading */}
          <h2 className="font-serif text-3xl font-bold leading-tight text-brand-cream sm:text-4xl lg:text-5xl md:w-1/3 text-center md:text-left">
          ...
          <div className="flex md:w-1/3 justify-center">
            <svg viewBox="0 0 100 100" className="size-20 text-brand-cream/30">
          ...
          <div className="flex md:w-1/3 justify-center md:justify-end gap-4">
            <Link
              ...
              className="flex size-12 items-center justify-center rounded-full border border-border/40 text-brand-cream transition-all hover:bg-brand-cream hover:text-brand-maroon"
            >
        ...
        <div className="relative flex items-center gap-4">
          {/* Left Arrow */}
          <button className="absolute left-4 z-10 flex size-12 items-center justify-center rounded-full bg-card/20 text-white backdrop-blur-md transition-all hover:bg-white hover:text-brand-maroon sm:-left-6">
          ...
          <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-2">
            {INSTAGRAM_IMAGES.slice(0, 2).map((img, idx) => (
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative aspect-square w-full overflow-hidden bg-card/5"
              >
                <Image
                  src={img.src}
                  alt={img.alt}
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-brand-maroon/0 transition-all duration-300 group-hover:bg-brand-maroon/40">
                  <div className="flex size-14 items-center justify-center rounded-full bg-card/0 opacity-0 transition-all duration-300 group-hover:bg-card/90 group-hover:opacity-100">
                    <Camera className="size-6 text-brand-maroon" />
                  </div>
                </div>
              </Link>
            ))}
          ...
          {/* Right Arrow */}
          <button className="absolute right-4 z-10 flex size-12 items-center justify-center rounded-full bg-card/20 text-white backdrop-blur-md transition-all hover:bg-white hover:text-brand-maroon sm:-right-6">
