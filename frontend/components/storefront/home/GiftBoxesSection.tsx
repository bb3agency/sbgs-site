      ...
      <div className="flex h-full w-full flex-col sm:flex-row">
        ...
        >
          ...
          <div className="absolute right-0 top-0 opacity-10">
             <svg viewBox="0 0 200 200" className="size-64 text-[#7F1416] sm:size-96">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="relative aspect-square w-full max-w-[400px] overflow-hidden rounded-full border border-[#7F1416]/20">
              <Image
          ...
          <div className="absolute bottom-8 left-8 z-10 flex flex-col items-start lg:bottom-12 lg:left-12">
            <h3 className="font-serif text-3xl font-normal italic text-[#7F1416] sm:text-4xl lg:text-5xl">
              Wedding Collections
            </h3>
          </div>
          ...
          {/* Carousel dots placeholder */}
          <div className="absolute bottom-8 right-8 z-10 flex gap-2 lg:bottom-12 lg:right-12">
            <div className="size-2 rounded-full bg-[#7F1416]" />
            <div className="size-2 rounded-full bg-[#7F1416]/40" />
            <div className="size-2 rounded-full bg-[#7F1416]/40" />
          </div>
        </Link>
      </div>
