      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-center lg:gap-10">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-2 font-heading text-2xl font-bold tracking-tight text-brand-maroon sm:text-3xl lg:text-4xl">
            ...
            <ul className="space-y-5">
              {POINTS.map(({ title, desc, icon: Icon }) => (
                <li key={title} className="flex items-start gap-3">
                  <span className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-card text-brand-gold shadow-sm">
