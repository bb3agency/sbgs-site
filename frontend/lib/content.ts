...
export const STORE_TAGLINE =
  "Authentic ghee sweets, handcrafted with a 40-year legacy of purity.";
export const STORE_TAGLINE_SHORT = "Authentic ghee sweets";
...
export const HOME_META_DESCRIPTION =
  "Authentic ghee sweets from Sri Sai Baba Ghee Sweets — handcrafted in Vijayawada with a 40-year legacy of purity. Delivered fresh.";
