...
export const metadata = {
  ...
  description:
    "How Sri Sai Baba Ghee Sweets collects, uses, stores, and protects your personal information when you shop for handcrafted sweets.",
};
...
const SECTIONS = [
  ...
  },
  {
    ...
    title: "6. Your Rights",
    content:
      "Under applicable Indian data protection law, you have the right to access, correct, or delete the personal data we hold about you. You can update your name, phone number, and delivery addresses directly from your account settings. To request a full data export or account deletion, contact us at hello@srisaibabagheesweets.com.",
  },
  {
    icon: Mail,
    title: "7. Contact & Updates",
    content:
      "We may update this policy as our practices evolve. Material changes will be communicated by email to registered customers. Continued use of the site after a policy update constitutes acceptance. For privacy questions or concerns, contact us at hello@srisaibabagheesweets.com.",
  },
];
        ...
        <div className="rounded-[20px] bg-white p-6 shadow-sm sm:p-8 lg:p-12">
          ...
          <div className="mt-10 rounded-[16px] border border-[#ece3d8] bg-[#fdf8f3] p-5 sm:p-6">
            <p className="text-sm font-medium text-[#767676]">
              <strong className="text-[#6B1D2A]">Privacy questions?</strong>{" "}
              Email us at{" "}
              <a
