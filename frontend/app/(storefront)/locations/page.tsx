    ...
    <div className="locations-page min-h-screen bg-[#fbf9f4] text-[#1b1c19] p-2 md:p-4 font-sans selection:bg-[#d48c2c] selection:text-white flex flex-col">
      <main className="max-w-7xl mx-auto w-full h-full flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 flex-1 min-h-0 grid-rows-4 md:grid-rows-2">
          ...
          <div className="md:col-span-1 md:row-span-2 bg-white rounded-[16px] p-3 md:p-4 relative overflow-hidden shadow-[0_32px_64px_-12px_rgba(27,28,25,0.04)] hover:shadow-[0_32px_64px_-12px_rgba(27,28,25,0.08)] transition-all duration-500 group flex flex-col justify-between border-none min-h-[250px] md:min-h-0">
            <iframe
          ...
          <div className="md:col-span-2 md:row-span-1 bg-white rounded-[16px] p-3 md:p-4 relative overflow-hidden shadow-[0_32px_64px_-12px_rgba(27,28,25,0.04)] hover:shadow-[0_32px_64px_-12px_rgba(27,28,25,0.08)] transition-all duration-500 group flex items-center border-none min-h-[200px] md:min-h-0">
            <iframe
            ...
            <div className="relative z-10 w-full flex flex-col md:flex-row justify-between gap-3 md:gap-4 items-start md:items-center">
              ...
              <div className="flex flex-col md:items-end gap-2 md:gap-3 shrink-0">
                ...
                <a href="https://www.google.com/maps/place/Sri+Sai+Baba+ghee+Sweets+and+home+food/data=!4m2!3m1!1s0x3a35eff83caf1a51:0x4c5897db5ec9191b" target="_blank" rel="noopener noreferrer" className="w-fit md:w-auto px-3 py-1.5 md:px-4 md:py-2 bg-white text-black rounded-full font-bold text-[10px] md:text-xs hover:bg-gray-200 transition-all shadow-lg flex items-center justify-center gap-1.5 group/btn">
                  Locate <ArrowRight className="w-3 h-3 md:w-3.5 md:h-3.5 group-hover/btn:translate-x-1 transition-transform" />
                </a>
              </div>
            </div>
          ...
          <div className="md:col-span-1 md:row-span-1 bg-white rounded-[16px] p-3 md:p-4 relative overflow-hidden shadow-[0_32px_64px_-12px_rgba(27,28,25,0.04)] hover:shadow-[0_32px_64px_-12px_rgba(27,28,25,0.08)] transition-all duration-500 group flex flex-col justify-between border-none min-h-[200px] md:min-h-0">
            <iframe
