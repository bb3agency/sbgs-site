...
export const metadata = {
  ...
  description:
    "How to raise a return request, what qualifies for a return, and how we process refunds for your sweets and savories orders.",
};
...
const SECTIONS = [
  {
    ...
    content:
      "Because our sweets and savories are freshly made food items, return or damage claims must be raised within 24 hours of delivery. Please inspect your order on arrival. Claims raised after 24 hours cannot be accepted for freshness-related issues.",
  },
  {
    icon: Camera,
  ...
  },
  {
    ...
    content:
      "We accept returns or replacements for: items damaged in transit, incorrect items delivered, quality issues, or items that have visibly spoiled before their expected shelf life. We reserve the right to request photographic evidence.",
  },
  {
    icon: XCircle,
    title: "4. Non-Eligible Returns",
    content:
      "We cannot accept returns for: items that have been stored incorrectly after delivery, natural variation in colour, texture, or shape (expected in handmade sweets), partially consumed items, or items that were delivered in good condition and later damaged by the customer.",
  },
  {
    icon: CreditCard,
      ...
      <section className="relative overflow-hidden bg-brand-gold/20 py-10 md:py-20">
        <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center justify-center px-4 text-center lg:px-8">
          ...
          >
            ...
            <span className="text-brand-gold">Return Policy</span>
          </nav>
        ...
        <div className="grid gap-6 sm:gap-8">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4">
            {[
              ...
              <div
                key={label}
                className="flex flex-col items-center justify-center rounded-[16px] bg-brand-maroon px-3 py-5 text-center sm:py-6"
              >
          ...
          <div className="rounded-[20px] bg-card p-6 shadow-sm sm:p-8 lg:p-12">
            ...
            <div className="mt-10 rounded-[16px] border border-border bg-brand-cream p-5 sm:p-6">
              <p className="text-sm font-medium text-muted-foreground">
                <strong className="text-brand-maroon">Need to raise a return?</strong>{" "}
                Go to{" "}
                <Link
                  href="/orders"
