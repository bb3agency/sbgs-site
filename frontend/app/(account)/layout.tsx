...
/**
 * Account area shares the storefront chrome: same Header/Footer and the same
 * StoreConfigProvider (Header, Footer and components like OrderReviewPrompt call
 * useStoreConfig(), which throws outside the provider).
 */
