      ...
      <section className="relative overflow-hidden bg-[#7F1416] py-12 md:py-20">
        <div className="relative mx-auto flex w-full max-w-[1440px] flex-col items-center justify-center px-4 text-center lg:px-8">
          ...
          >
            ...
            <span className="text-[#D4A537]">Categories</span>
          </nav>

          {/* Stats strip */}
          <div className="flex items-center gap-6 sm:gap-10 mt-4">
            <div className="text-center">
              <p className="font-serif text-xl font-normal text-[#FAF5EC] sm:text-2xl italic">{categories.length}</p>
              <p className="text-[10px] font-semibold uppercase tracking-widest text-[#FAF5EC]/60 font-['Montserrat']">Categories</p>
            </div>
            <div className="text-center">
              <p className="font-serif text-xl font-normal text-[#FAF5EC] sm:text-2xl italic">100%</p>
              <p className="text-[10px] font-semibold uppercase tracking-widest text-[#FAF5EC]/60 font-['Montserrat']">Pure Ghee</p>
            </div>
          </div>
        </div>
      </section>
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="flex flex-col items-center mt-2">
                  <h3 className="text-sm font-bold uppercase tracking-wider text-[#7F1416] sm:text-[13px] font-['Montserrat'] transition-colors duration-300 group-hover:text-[#D4A537]">
                    {cat.name}
                  </h3>
