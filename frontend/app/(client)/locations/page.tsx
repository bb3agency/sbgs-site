...
export const metadata: Metadata = {
  title: "Our Locations",
  description:
    "Find Sri Sai Baba Ghee Sweets branches near you. Explore our carefully selected locations across Vijayawada — each maintaining our 40-year legacy of purity.",
};

export default function LocationsPage() {
  return (
    <div className="locations-page min-h-screen bg-[#fbf9f4] text-[#1b1c19] p-2 md:p-4 font-sans selection:bg-[#d48c2c] selection:text-white flex flex-col">
      <main className="max-w-7xl mx-auto w-full h-full flex flex-col">
        ...
        <div className="mb-2 md:mb-4 flex flex-col md:flex-row md:items-end justify-between gap-2 shrink-0">
          <div className="max-w-2xl">
            <h2 className="text-[10px] font-bold text-[#875300] tracking-[0.15em] uppercase mb-1">
              Reach Us At
            </h2>
            <h1 className="font-[var(--font-location-display)] text-2xl md:text-3xl font-extrabold tracking-tight text-[#1b1c19] mb-1.5 leading-tight">
              Our Branches
            </h1>
            <p className="text-[#5a5a55] text-xs md:text-sm leading-relaxed">
              Explore our carefully selected locations. Each branch maintains our
              40-year legacy of purity with modern service standards.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 flex-1 min-h-0 grid-rows-4 md:grid-rows-2">
          ...
          <div className="md:col-span-1 md:row-span-2 bg-card rounded-[16px] p-3 md:p-4 relative overflow-hidden shadow-[0_32px_64px_-12px_rgba(27,28,25,0.04)] hover:shadow-[0_32px_64px_-12px_rgba(27,28,25,0.08)] transition-all duration-500 group flex flex-col justify-between border-none min-h-[250px] md:min-h-0">
            <iframe
            ...
            <div className="relative z-10 flex justify-between items-start">
              <div className="flex flex-col gap-1.5">
                <span className="text-[9px] font-bold px-2.5 py-1 rounded-full bg-green-500/20 text-green-300 backdrop-blur-md tracking-wide uppercase flex items-center gap-1 w-fit">
            ...
            <div className="relative z-10 mt-auto">
              <div className="flex flex-col gap-3">
                <div>
                  <h3 className="font-[var(--font-location-display)] text-lg md:text-xl font-bold text-white mb-1 tracking-tight drop-shadow-md">Check Post Centre</h3>
                ...
                <div className="flex justify-start">
                  <a href="https://www.google.com/maps/place/Sai+Baba+Sweets+%26+Cool+Drinks,+Old+Check+Post+Center/data=!4m2!3m1!1s0x3a35fae0b3d8ee27:0x4392c5d586a3c4" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 md:px-4 md:py-2 bg-card text-black rounded-full font-bold text-[10px] md:text-xs hover:bg-gray-200 transition-all shadow-lg flex items-center gap-1.5 group/btn">
          ...
          <div className="md:col-span-2 md:row-span-1 bg-card rounded-[16px] p-3 md:p-4 relative overflow-hidden shadow-[0_32px_64px_-12px_rgba(27,28,25,0.04)] hover:shadow-[0_32px_64px_-12px_rgba(27,28,25,0.08)] transition-all duration-500 group flex items-center border-none min-h-[200px] md:min-h-0">
            <iframe
            ...
            <div className="relative z-10 w-full flex flex-col md:flex-row justify-between gap-3 md:gap-4 items-start md:items-center">
              <div className="max-w-md">
                <h3 className="font-[var(--font-location-display)] text-base md:text-lg font-bold text-white mb-1 tracking-tight drop-shadow-md">One Town, Samarang Chowk</h3>
              ...
              <div className="flex flex-col md:items-end gap-2 md:gap-3 shrink-0">
                ...
                <a href="https://www.google.com/maps/place/Sri+Sai+Baba+ghee+Sweets+and+home+food/data=!4m2!3m1!1s0x3a35eff83caf1a51:0x4c5897db5ec9191b" target="_blank" rel="noopener noreferrer" className="w-fit md:w-auto px-3 py-1.5 md:px-4 md:py-2 bg-card text-black rounded-full font-bold text-[10px] md:text-xs hover:bg-gray-200 transition-all shadow-lg flex items-center justify-center gap-1.5 group/btn">
                  Locate <ArrowRight className="w-3 h-3 md:w-3.5 md:h-3.5 group-hover/btn:translate-x-1 transition-transform" />
                </a>
              </div>
            </div>
          ...
          <div className="md:col-span-1 md:row-span-1 bg-card rounded-[16px] p-3 md:p-4 relative overflow-hidden shadow-[0_32px_64px_-12px_rgba(27,28,25,0.04)] hover:shadow-[0_32px_64px_-12px_rgba(27,28,25,0.08)] transition-all duration-500 group flex flex-col justify-between border-none min-h-[200px] md:min-h-0">
            <iframe
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-black/20 z-0"></div>
            <div className="relative z-10 mt-auto">
              <h3 className="font-[var(--font-location-display)] text-sm md:text-base font-bold text-white mb-0.5 tracking-tight drop-shadow-md">Jammichettu Center</h3>
              <p className="text-white/80 text-[9px] md:text-[10px] mb-1.5 drop-shadow-md">Moghalraj Puram</p>
              <div className="flex flex-col gap-0.5 mb-2 bg-black/30 backdrop-blur-md px-2 py-1 rounded-lg w-fit">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="https://www.google.com/maps/place/Sri+sai+baba+ghee+sweets+and+home+foods/data=!4m2!3m1!1s0x3a35fb163061d285:0x13742cd6c4080b29" target="_blank" rel="noopener noreferrer" className="px-2.5 py-1 md:px-3 md:py-1.5 bg-card text-black rounded-full font-bold text-[9px] md:text-[10px] hover:bg-gray-200 transition-all shadow-md flex items-center gap-1 group/btn">
          ...
          <div className="md:col-span-1 md:row-span-1 bg-card rounded-[16px] p-3 md:p-4 relative overflow-hidden shadow-[0_32px_64px_-12px_rgba(27,28,25,0.04)] hover:shadow-[0_32px_64px_-12px_rgba(27,28,25,0.08)] transition-all duration-500 group flex flex-col justify-between border-none min-h-[200px] md:min-h-0">
            ...
            <div className="relative z-10">
              <span className="text-[8px] md:text-[9px] font-bold px-2 py-0.5 md:px-2.5 md:py-1 rounded-full bg-card/20 text-white backdrop-blur-md tracking-wide uppercase">
                Main Branch
              </span>
            </div>
            <div className="relative z-10 mt-auto">
              <h3 className="font-[var(--font-location-display)] text-sm md:text-base font-bold text-white mb-0.5 tracking-tight drop-shadow-md">100 Feet Road</h3>
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <a href="https://www.google.com/maps/place/Sri+sai+baba+Ghee+sweets+and+home+foods/data=!4m2!3m1!1s0x3a35fad96c55b64f:0xc8892b7800bca8f8" target="_blank" rel="noopener noreferrer" className="px-2.5 py-1 md:px-3 md:py-1.5 bg-card text-black rounded-full font-bold text-[9px] md:text-[10px] hover:bg-gray-200 transition-all shadow-md flex items-center gap-1 group/btn">
                  Locate <ArrowRight className="w-2.5 h-2.5 md:w-3 md:h-3 group-hover/btn:translate-x-1 transition-transform" />
                </a>
              </div>
            </div>
