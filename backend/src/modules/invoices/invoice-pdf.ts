...
const styles = StyleSheet.create({
  ...
  th: { fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: MUTED, letterSpacing: 0.5, textTransform: 'uppercase', paddingLeft: 5 },
  tableRow: {
    flexDirection: 'row',
    paddingVertical: 6,
    paddingHorizontal: 6,
  ...
  td: { fontSize: 9, paddingLeft: 5 },
  tdMuted: { fontSize: 8.5, color: MUTED, paddingLeft: 5 },
  ...
  giName: { width: '20%' },
  giHsn: { width: '8%' },
  giRate: { width: '6%', textAlign: 'right' },
  giQty: { width: '12%', textAlign: 'right' },
  giUnit: { width: '15%', textAlign: 'right' },
  giTaxable: { width: '11.5%', textAlign: 'right' },
  giCgst: { width: '9%', textAlign: 'right' },
  giSgst: { width: '9%', textAlign: 'right' },
  giTotal: { width: '9.5%', textAlign: 'right' },
  // GST layout, inter-state (single IGST column).
  geName: { width: '23%' },
  geHsn: { width: '9%' },
  geRate: { width: '6%', textAlign: 'right' },
  geQty: { width: '13%', textAlign: 'right' },
  geUnit: { width: '16%', textAlign: 'right' },
  geTaxable: { width: '12%', textAlign: 'right' },
  geIgst: { width: '11%', textAlign: 'right' },
  geTotal: { width: '10%', textAlign: 'right' },
